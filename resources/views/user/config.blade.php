...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            @endif
            <div class="card">
                <div class="card-header"><strong>Configuración de mi cuenta</strong></div>
                    ...
                    <form method="POST" action="{{ route('user.update')}}" enctype="multipart/form-data" >
                        ...
                        <div class="row mb-3">    
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="image_path" type="file" class="form-control @error('image_path') is-invalid @enderror" name="image_path" value="{{ Auth::user()->image_path }}" required autocomplete="image_path" autofocus>
